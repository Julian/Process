...
REPO_ROOT = Path.from_string(__file__).parent().parent()
...
description = u"Testing-friendly subprocess spawning"

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
#
version = release = vcversioner.find_version(root=str(REPO_ROOT)).version
...
man_pages = [(master_doc, "process", project, [author], 1)]
